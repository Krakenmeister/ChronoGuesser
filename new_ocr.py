...
processor_id = "83a7966a2733926b"  # Create processor before running sample
# Must end with a trailing slash `/`. Format: gs://bucket/directory/subdirectory/
gcs_output_uri = "gs://chronoguesser/documents"
...
# gcs_input_uri = "gs://chronoguesser/newspapers/highdef.jpg" # Format: gs://bucket/directory/file.pdf
# input_mime_type = "application/pdf"
# Format: gs://bucket/directory/
gcs_input_prefix = "gs://chronoguesser/newspapers/"
    ...
    for process in list(metadata.individual_process_statuses):
        ...
        for blob in output_blobs:
            ...
            if blob.content_type != "application/json":
                ...
                print("Skipping non-supported file")
                continue
...
batch_process_documents(project_id, location, processor_id,
                        gcs_output_uri, gcs_input_prefix)
